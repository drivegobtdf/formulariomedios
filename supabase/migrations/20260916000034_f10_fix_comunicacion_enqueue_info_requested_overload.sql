-- =============================================================================
-- Migration 034: Fix function ambiguity for comunicacion_enqueue_info_requested
--                Drop obsolete (uuid) overload and retain canonical (uuid, jsonb)
-- =============================================================================

-- 1. Eliminar la sobrecarga obsoleta de un solo parámetro que causa ambigüedad en llamadas SQL con un único argumento UUID
DROP FUNCTION IF EXISTS public.comunicacion_enqueue_info_requested(uuid);

-- 2. Asegurar la versión canónica con soporte para encrypted_envelope y valor DEFAULT NULL
...
-- 3. Permisos granulares de ejecución
