-- =============================================================================
-- Migración 051: Fix Admin Alert Operational Date Extraction
-- Proyecto: PEDIDOS — Secretaría de Medios (Gobierno de Tierra del Fuego AIAS)
-- Extrae la fecha operativa real de informacion_especifica (fecha, fecha_limite,
-- fecha_sugerida, grabacion_fecha) para que la alerta a administradores no muestre '-'
-- =============================================================================
...
BEGIN
    ...
    FOR v_ped IN
        SELECT 
            ...
            COALESCE(
                p.fecha_limite::text,
                p.informacion_especifica->>'fecha',
                p.informacion_especifica->>'fecha_limite',
                p.informacion_especifica->>'fecha_sugerida',
                p.informacion_especifica->>'grabacion_fecha'
            ) AS fecha_operativa,
        ...
        LOOP
            ...
            INSERT INTO public.comunicaciones_pedido (
                ...
                jsonb_build_object(
                    ...
                    'fecha_limite', v_ped.fecha_operativa,
                    'fecha', v_ped.fecha_operativa,
                    'fecha_operativa', v_ped.fecha_operativa,
