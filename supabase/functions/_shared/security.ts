...
export function getCorsHeaders(req: Request): Record<string, string> {
  ...
  const rawAllowed =
    ...
    'http://localhost:5173,http://127.0.0.1:5173,http://localhost:4173,http://127.0.0.1:4173,http://localhost:4174,http://127.0.0.1:4174,http://localhost:8080,http://127.0.0.1:8080,https://formulariomedios.netlify.app,https://formulariomedios.pages.dev,https://formulariomedios.tierradelfuego.gob.ar';
